...
const defaultComponents = memoizeMarkdownComponents({
  ...
  h2: ({ className, ...props }) => (
    <h2
      className={cn(
        "aui-md-h2 mt-3 mb-1.5 scroll-m-20 font-semibold text-md first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  h3: ({ className, ...props }) => (
    <h3
      className={cn(
        "aui-md-h3 mt-2.5 mb-1 scroll-m-20 font-semibold text-md first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
